...
@Entity
@Table(name = "T_COMPANY_CHANGE_STATE", schema = "MEMBER", catalog = "")
public class TCompanyChangeState {
    private long id;
    private String qyid;
    private Time gxsj;
    private String gxry;
    ...
    public boolean equals(Object o) {
        ...
        TCompanyChangeState that = (TCompanyChangeState) o;
        return id == that.id &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, qyid, gxsj, gxry, gxryxm, gxbm, gxbmmc, zzid, zzmc, gxly, gxtype, shid);
    }
}
