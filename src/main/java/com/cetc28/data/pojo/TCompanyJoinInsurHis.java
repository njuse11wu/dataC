...
@Entity
@Table(name = "T_COMPANY_JOIN_INSUR_HIS", schema = "MEMBER", catalog = "")
public class TCompanyJoinInsurHis {
    private long id;
    private String qyid;
    private Long nf;
    private String shbxcjlx;
    private Integer shbxcjrs;
    ...
    public Integer getShbxcjrs() {
        return shbxcjrs;
    }

    public void setShbxcjrs(Integer shbxcjrs) {
    ...
    public boolean equals(Object o) {
        ...
        TCompanyJoinInsurHis that = (TCompanyJoinInsurHis) o;
        return id == that.id &&
