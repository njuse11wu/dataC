...
@Entity
@Table(name = "T_PERSON_BASIC_INFO_HIS", schema = "MEMBER", catalog = "")
public class TPersonBasicInfoHis {
    private String ryid;
    private String yhid;
    private String ryfl;
    private String xm;
    ...
    @Basic
    @Column(name = "CJGZSJ")
    public Time getCjgzsj() {
        return cjgzsj;
    }

    public void setCjgzsj(Time cjgzsj) {
        this.cjgzsj = cjgzsj;
    }
    ...
    @Basic
    @Column(name = "JRMSCSJ")
    public Time getJrmscsj() {
        return jrmscsj;
    }

    public void setJrmscsj(Time jrmscsj) {
    ...
    public boolean equals(Object o) {
        ...
        TPersonBasicInfoHis that = (TPersonBasicInfoHis) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(ryid, yhid, ryfl, xm, xb, csrq, mz, zjlx, zjhm, xl, xw, zzmm, gzdw, zw, txdz, lxdh, yx, jg, csd, zj, yb, cym, zp, qq, wx, sxzzbx, grjl, cjsj, cjry, cjryxm, cjbmmc, gxsj, gxry, gxryxm, gxbm, gxbmmc, cz, cjbm, shgatrs, sfqdwggj, cjgzsj, gzdwszds, jcqk, fhzxh, rdsj, lxrxm, isrealdata, msczw, jrmscsj, dataId, photopath, sxbz, gasf, shmc, shzch, gj, brsjhm, dwjzw, zcze, zgrs, rhsj);
    }
}
