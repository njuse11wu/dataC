...
@Entity
@Table(name = "T_UNION_CONTACT_HIS", schema = "MEMBER", catalog = "")
public class TUnionContactHis {
    private long id;
    private String ttid;
    private String lxr;
    ...
    public boolean equals(Object o) {
        ...
        TUnionContactHis that = (TUnionContactHis) o;
        return id == that.id &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, ttid, lxr, lxrdh, lxrsjh, cjsj, cjry, cjryxm, cjbm, cjbmmc, gxsj, gxry, gxryxm, gxbm, gxbmmc);
    }
}
