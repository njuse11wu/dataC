...
@Entity
@Table(name = "T_UNION_GSL_MAP", schema = "MEMBER", catalog = "")
public class TUnionGslMap {
    private long id;
    private String ttid;
    private String zzid;
    private String zzmc;
    ...
    public boolean equals(Object o) {
        ...
        TUnionGslMap that = (TUnionGslMap) o;
        return id == that.id &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, ttid, zzid, zzmc, jrsj, sfzt, cjsj, cjry, cjryxm, cjbm, cjbmmc);
    }
}
